...
export const services = [
  ...
  },
  {
    ...
    shortDescription: 'Complete GST registration lifecycle with proactive filing reminders and intelligence dashboards.',
    description: 'Navigate the complexities of GST with our comprehensive registration and return filing services. We ensure 100% compliance while minimizing your tax burden through strategic planning.',
  ...
  },
  {
    ...
    shortDescription: 'AI-assisted document prep, optimization strategies, and professional filing across entities.',
    description: 'Maximize your tax savings with our expert Income Tax Return filing services. We use advanced tools and deep expertise to ensure accurate filing while optimizing your tax liability legally.',
    tag: 'Tax Strategy',
  ...
  },
  {
    ...
    shortDescription: 'Full-stack accounting desk with cloud books, management reports, and CFO level insights.',
    description: 'Transform your financial management with our comprehensive accounting services. From daily bookkeeping to strategic financial insights, we provide end-to-end accounting solutions.',
    tag: 'Finance Desk',
  ...
  },
  {
    ...
    shortDescription: 'End-to-end incorporation with branding-ready documents and compliance starter kits.',
    description: 'Start your business journey with proper legal foundation. We handle all aspects of business registration including proprietorship, partnership, LLP, and company incorporation.',
    tag: 'Business Setup',
  ...
  },
  {
    ...
    shortDescription: 'Udyam registration support with accurate classification, document checklist, and certificate guidance for eligible businesses.',
    description: 'Unlock government benefits and subsidies with MSME/Udyam registration. We help you classify your enterprise correctly and obtain the official Udyam certificate.',
    tag: 'Business Setup',
  ...
  },
  {
    ...
    shortDescription: 'Global-ready IEC registrations with trade advisory and onboarding collaterals.',
    description: 'Expand your business globally with Import Export Code registration. We handle the complete IEC application process and provide trade advisory services.',
    tag: 'Global Trade',
  ...
  },
  {
    ...
    shortDescription: 'Brand-first trademark, logo, and copyright desk with monitoring and renewal support.',
    description: 'Protect your brand identity with our comprehensive trademark and intellectual property services. From search to registration to enforcement, we safeguard your business assets.',
    tag: 'Brand Guard',
  ...
  },
  {
    ...
    shortDescription: 'Employee-first compliance with automated challans, audit prep, and advisory calls.',
    description: 'Ensure complete employee welfare compliance with our ESIC and PF registration and management services. We handle everything from registration to monthly challans to inspections.',
    tag: 'People Care',
